...
module soc_system_hps_0 #(
		...
		input  wire         f2h_dma_req0_req,         //        f2h_dma_req0.dma_req
		input  wire         f2h_dma_req0_single,      //                    .dma_single
		output wire         f2h_dma_req0_ack,         //                    .dma_ack
		input  wire         f2h_dma_req1_req,         //        f2h_dma_req1.dma_req
		input  wire         f2h_dma_req1_single,      //                    .dma_single
		output wire         f2h_dma_req1_ack,         //                    .dma_ack
	...
	soc_system_hps_0_fpga_interfaces fpga_interfaces (
		...
		.f2h_dma_req1_req         (f2h_dma_req1_req),         //        f2h_dma_req1.dma_req
		.f2h_dma_req1_single      (f2h_dma_req1_single),      //                    .dma_single
		.f2h_dma_req1_ack         (f2h_dma_req1_ack),         //                    .dma_ack
